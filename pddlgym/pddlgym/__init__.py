...
# @vla: add custom snake environments
# domain_file = './pddlgym/pddlgym/pddl/snake.pddl'
# other_args = {'render' : snake_render,
#               'operators_as_actions' : True,
#               'dynamic_action_space' : True}

# for level in range(2,3):
#     problem_file = f'pddlgym/pddlgym/pddl/snake/p{level:02d}.pddl'
#     register(
#         id=f'PDDLEnvSnake_p{level:02d}',
#         entry_point='pddlgym.core:PDDLEnv',
#         kwargs=dict({'domain_file' : domain_file, 'problem_dir' : problem_file,
#                      **other_args}),
#     )
